...
*/
	...
	public:
		...
		bool open_reading(const std::string& file_name, const std::function<bool(FILE*)>& header_parser = [](FILE*) {return true; })
		{
			if (working_mode != working_mode_t::none)
				return false;
		...
		bool open_writing(const std::string& file_name, const std::function<bool(FILE*)>& header_writer = [](FILE*) {return true; })
		{
			if (working_mode != working_mode_t::none)
				return false;
